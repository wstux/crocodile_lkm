...
#ifndef _CROCODILE_LKM_LOGGING_SEVERITY_LEVEL_IMPL_H_
#define _CROCODILE_LKM_LOGGING_SEVERITY_LEVEL_IMPL_H_
...
#define _INIT_PLOGGER_IMPL(logger, level)   _init_logger(level)
#define _LOG_LEVEL(level)                   _IMPL_LOG_LVL_ ## level
#define _PLOGGER_CAN_LOG(logger, level)     _can_log(level)
